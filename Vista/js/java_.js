        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block" >
              <h5>Santiago Mape</h5>
              <p id="Funda">Fundador y Desarrollador del Sistema de Gestion Online de Inventario SLD</p>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h5>Laura Gongora</h5>
              <p id="Funda">Creadora del Sistema de Gestion Online de Inventario SLD</p>
            </div>
          </div>
        </div>
  ...
  swalConBotonesBootstrap
    ...
    .then((result) => {
      ...
      if (result.isConfirmed) {
        ...
        swalConBotonesBootstrap
        .fire({
          title: "Deseas Incluir Trabajadores y Clientes a tu Reporte", // Título del cuadro de diálogo
          text: "Al descargar tendrás tu reporte de: Trabajadores, Clientes, Proveedores, Productos y Ventas.", // Texto principal
          icon: "warning", // Ícono de advertencia
          showCancelButton: true, // Mostrar botón de cancelar
          confirmButtonText: "Sí, deseo continuar!", // Texto del botón de confirmación
          cancelButtonText: "No, continuar con la anterior!", // Texto del botón de cancelación
          reverseButtons: true, // Invertir posición de los botones (confirmar y cancelar)
        })
        .then((result) => {
          // Manejar la acción después de hacer clic en los botones de confirmar o cancelar
          if (result.isConfirmed) {
            ...
            window.location.href = "index.php?accion=DescargaUC";
  ...
  swalWithBootstrapButtons
    ...
    .then((result) => {
      if (result.isConfirmed) {
        $.get(
          "index.php",
          { accion: "eliminarusu", numero: numero },
          function () {
            swalWithBootstrapButtons
              .fire({
                title:
                  "El Trabajador/a " + nombre + " ha sido Eliminado Exitosamente!",
                icon: "success",
              })
              .then(() => {
  ...
  swalWithBootstrapButtons
    ...
    .then((result) => {
      if (result.isConfirmed) {
        $.get(
          "index.php",
          { accion: "eliminarRol", numero: numero },
          function () {
            swalWithBootstrapButtons
              .fire({
  ...
  swalWithBootstrapButtons
    ...
    .then((result) => {
      if (result.isConfirmed) {
        $.get(
          "index.php",
          { accion: "eliminarcli", numero3: numero3 },
          function () {
            swalWithBootstrapButtons
              .fire({
                title:
  ...
  swalWithBootstrapButtons
    ...
    .then((result) => {
      if (result.isConfirmed) {
        $.get(
          "index.php",
          { accion: "eliminarpro", numero: numero },
          function () {
            swalWithBootstrapButtons
              .fire({
                title:
  ...
  swalWithBootstrapButtons
    ...
    .then((result) => {
      if (result.isConfirmed) {
        $.get(
          "index.php",
          { accion: "eliminarprodu", numero4: numero4 },
          function () {
            swalWithBootstrapButtons
              .fire({
                title:
                  "El Producto " + nombre + " ha sido Eliminado Exitosamente!",
                icon: "success",
              })
              .then(() => {
                // Recarga la página después de la confirmación de eliminación
  ...
  swalWithBootstrapButtons
    ...
    .then((result) => {
      if (result.isConfirmed) {
        $.get(
          "index.php",
          { accion: "eliminarven", numero5: numero5 },
          function () {
            swalWithBootstrapButtons
              .fire({
                title:
                  "La Venta " + numero5 + " ha sido Eliminada Exitosamente!",
                icon: "success",
              })
              .then(() => {
                // Recarga la página después de la confirmación de eliminación
