...
<form action="index.php?accion=actualizarprodu" method="POST" id="agregarusuario" novalidate>
    <div class="modal-body">
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Codigo</span>
            <input type="text" class="form-control" placeholder="Codigo del Producto" aria-label="Nombre" aria-describedby="basic-addon1" value="<?php echo $filas['codprodu']; ?>" readonly id="codprodu" name="codprodu">
        </div>
        <div class="input-group mb-3">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Existencia" aria-label="existencia" aria-describedby="basic-addon1" value="<?php echo $filas['existenciaprodu']; ?>" id="exisprodu" name="exisprodu">
        </div>
        <div class="input-group mb-3">
