                            ...
                            ?>
                                ...
                                ?>
                                    <script>
                                        Swal.fire({
                                            icon: "warning",
                                            title: "¡El Proveedor ingresado ya se encuentra Registrado!",
                                            showConfirmButton: false,
                                            timer: 2000
                                        });
                                    </script>
                            ...
                            ?>
                                ...
                                ?>
                                    <script>
                                        Swal.fire({
                                            icon: "error",
                                            title: "Oops... Al parecer, no hubo cambios o hubo un error al actualizar el Proveedor. ¡Inténtelo de nuevo!",
                                        });
                                    </script>
                            <?php
                                }
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="index.php?accion=ingresarProveedor" method="POST" id="agregarproveedor">
                                                ...
                                                <script>
                                                    document.getElementById('telprovee').addEventListener('input', function(e) {
                                                        var input = e.target;
                                                        var value = input.value;
                                                        // Eliminar cualquier carácter no numérico
                                                        value = value.replace(/\D/g, '');
